...
class Table extends React.Component{
    constructor(props){
        ...
        this.mealTableColumnsName = [{id: "Id"}, {name: "Nom"}, {description: "Description"}, {portion_number: "Nombre de portion"}, {publication_date: "Date de publication"}, {user_fk: "Pseudo de l'utilisateur"}, {category_fk: "Categorie"}, {order_fk: "Id de la commande"}, {image:"Image du plat"}]; 
